...
public class Gui extends JFrame {
  ...
  private String[] tIdSelections = {"T001", "T002", "T003", "T004", "T005", "T006", "T007", "T008", "T009", "T0010"};
...
//BrowseFiles panel
	...
	inputFile.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	filePath.setFont(new Font("Centaur",Font.PLAIN, 17));
	...
	browseButton.setFont(new Font("Centaur",Font.BOLD, 17));
	...
	confirmButton.setFont(new Font("Centaur",Font.BOLD, 17));
...
//Login panel
	...
	staffID.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	staffPW.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	inputStaffID.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	invalidID.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	inputStaffPW.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	invalidPW.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	login.setFont(new Font("Centaur",Font.BOLD, 20));
...
//Options panel for managers
	...
	mOptions.setFont(new Font("Centaur",Font.BOLD, 25));
...
//Details
	...
	mDetailsLabel.setFont(new Font("Centaur",Font.BOLD, 25));
	...
	mID.setFont(new Font("Centaur",Font.BOLD, 20));
	mID.setForeground(new Color(255, 255, 255));
	mID.setVisible(false);
		
	DefaultComboBoxModel model = new DefaultComboBoxModel(tIdSelections);
	final JComboBox mInputID = new JComboBox(model);
	tab.add(mInputID);
	mInputID.setBounds(655, 75, 170, 25);
	mInputID.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mFoodID.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mInputFoodID.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	final JLabel mStaffName = new JLabel("Name:");
	tab.add(mStaffName);
	mStaffName.setBounds(575, 110, 70, 25);
	mStaffName.setHorizontalAlignment(JLabel.RIGHT);
	mStaffName.setFont(new Font("Centaur",Font.BOLD, 20));
	mStaffName.setForeground(new Color(255, 255, 255));
	mStaffName.setVisible(false);
	
	final JTextArea mInputStaffName = new JTextArea();
	tab.add(mInputStaffName);
	mInputStaffName.setBounds(655, 110, 170, 25);
	mInputStaffName.setFont(new Font("Centaur",Font.BOLD, 20));
	mInputStaffName.setForeground(new Color(128, 128, 128));
	mInputStaffName.setVisible(false);
	
	final JLabel mPosition = new JLabel("Position:");
	tab.add(mPosition);
	mPosition.setBounds(575, 145, 70, 25);
	mPosition.setHorizontalAlignment(JLabel.RIGHT);
	mPosition.setFont(new Font("Centaur",Font.BOLD, 17));
	mPosition.setForeground(new Color(255, 255, 255));
	mPosition.setVisible(false);
	
	final JTextArea mInputPosition = new JTextArea();
	tab.add(mInputPosition);
	mInputPosition.setBounds(655, 145, 170, 25);
	mInputPosition.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mSalary.setFont(new Font("Centaur",Font.BOLD, 20));
	mSalary.setForeground(new Color(255, 255, 255));
	mSalary.setVisible(false);
	
	final JTextArea mInputSalary = new JTextArea();
	tab.add(mInputSalary);
	mInputSalary.setBounds(655, 180, 170, 25);
	mInputSalary.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mPassword.setFont(new Font("Centaur",Font.BOLD, 17));
	...
	mInputPassword.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mSubmit.setFont(new Font("Centaur",Font.BOLD, 15));
	...
	mResult.setFont(new Font("Centaur",Font.BOLD, 20));
...
//Profit	
	...
	mProfit.setFont(new Font("Centaur",Font.BOLD, 20));
...
//Revenue	
	...
	mRevenue.setFont(new Font("Centaur",Font.BOLD, 20));
...
//Cost	
	...
	mCost.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mShowDetails.setBackground(new Color(253, 198, 115));	
					
	final JTextArea mList = new JTextArea("");
	tab.add(mList);
	mList.setFont(new Font("Centaur",Font.BOLD, 15));
...
//Order
	...
	mAddOrder.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mAddOrder.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			mSubmit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					String str = "addOrder " + (String)mInputID.getSelectedItem() + " " + mInputFoodID.getText();
	...
	mListOrder.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mEditOrder.setFont(new Font("Centaur",Font.BOLD, 20));
	...
	mDeleteOrder.setFont(new Font("Centaur",Font.BOLD, 20));
...
//Food
	...
	mAddFood.setFont(new Font("Centaur",Font.BOLD, 20));
	mAddFood.setBackground(new Color(185, 223, 255));
	...
	mListFood.setFont(new Font("Centaur",Font.BOLD, 20));
	mListFood.setBackground(new Color(185, 223, 255));	
	...
	mEditFood.setFont(new Font("Centaur",Font.BOLD, 20));
	mEditFood.setBackground(new Color(185, 223, 255));
	...
	mDeleteFood.setFont(new Font("Centaur",Font.BOLD, 20));
	mDeleteFood.setBackground(new Color(185, 223, 255));
...
//Ingredient
	...
	mAddIng.setFont(new Font("Centaur",Font.BOLD, 20));
	mAddIng.setBackground(new Color(240, 196, 255));
	...
	mListIng.setFont(new Font("Centaur",Font.BOLD, 20));
	mListIng.setBackground(new Color(240, 196, 255));
	...
	mEditIng.setFont(new Font("Centaur",Font.BOLD, 20));
	mEditIng.setBackground(new Color(240, 196, 255));	
	...
	mDeleteIng.setFont(new Font("Centaur",Font.BOLD, 20));
	mDeleteIng.setBackground(new Color(240, 196, 255));
...
//Reserve Table
	...
	mRTable.setFont(new Font("Centaur",Font.BOLD, 20));
	mRTable.setBackground(new Color(255, 213, 220));
	...
	mListRTable.setFont(new Font("Centaur",Font.BOLD, 20));
	mListRTable.setBackground(new Color(255, 213, 220));
	...
	mEditRTable.setFont(new Font("Centaur",Font.BOLD, 20));
	mEditRTable.setBackground(new Color(255, 213, 220));
	...
	mDeleteRTable.setFont(new Font("Centaur",Font.BOLD, 20));
	mDeleteRTable.setBackground(new Color(255, 213, 220));
...
//Staff	
	...
	mAddStaff.setFont(new Font("Centaur",Font.BOLD, 20));
	mAddStaff.setBackground(new Color(255, 225, 193));
	...
	mListStaff.setFont(new Font("Centaur",Font.BOLD, 20));
	mListStaff.setBackground(new Color(255, 225, 193));
	...
	mEditStaff.setFont(new Font("Centaur",Font.BOLD, 20));
	mEditStaff.setBackground(new Color(255, 225, 193));
	...
	mDeleteStaff.setFont(new Font("Centaur",Font.BOLD, 20));
	mDeleteStaff.setBackground(new Color(255, 225, 193));
